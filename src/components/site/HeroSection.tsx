      ...
      <div className="relative mx-auto max-w-none px-6 pt-28 pb-24 sm:px-10 sm:pt-36 sm:pb-32 lg:px-20 xl:px-32">
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="w-full">
            {/* Badge */}
            <div className="animate-fade-in-up inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/5 px-4 py-1.5 font-mono text-xs uppercase tracking-widest text-primary backdrop-blur-sm">
            ...
            <div className="animate-fade-in-up delay-300 mt-12 flex flex-wrap items-center gap-4">
              ...
              <a
                href="#contact"
                className="group inline-flex items-center gap-2 rounded-lg border border-border/80 bg-background/80 px-6 py-3 text-sm font-medium text-foreground backdrop-blur-sm transition-all hover:border-primary/40 hover:bg-primary/10 hover:shadow-md"
              >
          ...
          <div className="animate-slide-in-right delay-400 hidden lg:block">
            <div className="float relative">
              ...
              <div className="absolute -inset-8 rounded-3xl bg-gradient-to-br from-primary/20 via-primary/5 to-transparent blur-3xl" />
              {/* Card with spotlight effect */}
              <div className="spotlight-card relative overflow-hidden rounded-2xl border border-border/60 bg-card/95 shadow-2xl backdrop-blur-xl">
                ...
                <div className="flex items-center gap-2 border-b border-border/60 bg-muted/30 px-5 py-3.5">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    <span className="rounded-full bg-emerald-500/10 px-2 py-0.5 font-mono text-[9px] uppercase tracking-widest text-emerald-500">
                      Live
                    </span>
                ...
                <div className="relative flex p-0">
                  {/* Line numbers */}
                  <div className="border-r border-border/30 px-3 py-5 text-right font-mono text-[11px] leading-[2.2] text-muted-foreground/40 select-none">
                    <p>1</p>
                    <p>2</p>
                    <p>3</p>
                    <p>4</p>
                  ...
                  <div className="p-5 font-mono text-[13px] leading-[2.2]">
                    <p>
                      <CodeLine text="class" delay={500} className="text-primary/70" />{" "}
                      <CodeLine text="Engineer" delay={700} className="text-foreground" />
                      <CodeLine text=":" delay={900} className="text-muted-foreground" />
                    </p>
                    <p className="pl-4">
                      <CodeLine text="def" delay={1100} className="text-primary/70" />{" "}
                      <CodeLine text="__init__" delay={1300} className="text-foreground" />
                      <CodeLine text="(self):" delay={1500} className="text-muted-foreground" />
                    </p>
                    <p className="pl-8">
                      <CodeLine text="self" delay={1800} className="text-primary/70" />
                      <CodeLine text="." delay={1950} className="text-muted-foreground" />
                      <CodeLine text="focus" delay={2000} className="text-foreground" />
                      {" "}
                      <CodeLine text="=" delay={2200} className="text-muted-foreground" />
                      {" "}
                      <CodeLine text='"AI/ML"' delay={2300} className="text-primary/60" />
                    </p>
                    <p className="pl-8">
                      <CodeLine text="self" delay={2700} className="text-primary/70" />
                      <CodeLine text="." delay={2850} className="text-muted-foreground" />
                      <CodeLine text="stack" delay={2900} className="text-foreground" />
                      {" "}
                      <CodeLine text="=" delay={3100} className="text-muted-foreground" />
                      {" "}
                      <CodeLine text="[" delay={3200} className="text-muted-foreground" />
                      <CodeLine text='"Python"' delay={3250} className="text-primary/60" />
                      <CodeLine text="," delay={3500} className="text-muted-foreground" />
                      {" "}
                      <CodeLine text='"PyTorch"' delay={3550} className="text-primary/60" />
                      <CodeLine text="]" delay={3800} className="text-muted-foreground" />
                    </p>
                    <p className="pl-8">
                      <CodeLine text="self" delay={4100} className="text-primary/70" />
                      <CodeLine text="." delay={4250} className="text-muted-foreground" />
                      <CodeLine text="status" delay={4300} className="text-foreground" />
                      {" "}
                      <CodeLine text="=" delay={4500} className="text-muted-foreground" />
                      {" "}
                      <CodeLine text='"seeking_intern"' delay={4600} className="text-primary/60" />
                    </p>
                    <p />
                    <p className="pl-4">
                      <CodeLine text="def" delay={5200} className="text-primary/70" />{" "}
                      <CodeLine text="build" delay={5400} className="text-foreground" />
                      <CodeLine text="(self, idea):" delay={5600} className="text-muted-foreground" />
                    </p>
                    <p className="pl-8">
                      <CodeLine text="return" delay={6100} className="text-primary/70" />{" "}
                      <CodeLine text="self" delay={6400} className="text-primary/70" />
                      <CodeLine text="." delay={6550} className="text-muted-foreground" />
                      <CodeLine text="ship" delay={6600} className="text-foreground" />
                      <CodeLine text="(idea)" delay={6800} className="text-muted-foreground" />
                    </p>
                  </div>
        ...
        <div className="animate-fade-in-up delay-500 mt-20 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {[
            ...
            <div
              key={item.k}
              className="gradient-border group relative rounded-xl border border-border/60 bg-card/60 p-5 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:bg-card/80 hover:shadow-xl hover:shadow-primary/10"
            >
